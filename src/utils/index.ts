...
export function parseWeightForInput(weight: string | number | null | undefined): string {
...
export function formatWeightDisplay(weight: string | number | null | undefined): string {
